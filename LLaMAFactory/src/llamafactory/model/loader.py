...
from .modeling_value_head import AutoModelForCausalLMWith2ValueHead
...
def load_model(
    ...
    if add_2valuehead:
        model = AutoModelForCausalLMWith2ValueHead.from_pretrained(model)
        patch_valuehead_model(model)
